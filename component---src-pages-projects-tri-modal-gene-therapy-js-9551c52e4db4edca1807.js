"use strict";(self.webpackChunkcvc_website=self.webpackChunkcvc_website||[]).push([[665],{7053:function(t,e,i){i.r(e),i.d(e,{Head:function(){return y}});var a=i(4506),n=i(6540),s=i(7528),r=i(4794);const l=String.raw`
<div class="back">
  <a href="/projects">
...
`,o=[{label:"Natural History / FUS Only",shortLabel:"NH",color:"#ef4444",dash:[],final:1325,shape:"rise"},{label:"SP2 (SRT)",shortLabel:"SP2",color:"#f97316",dash:[6,4],final:580,shape:"mild"},{label:"AAV Only",shortLabel:"AAV",color:"#a78bfa",dash:[6,4],final:470,shape:"mild2"},{label:"SP2 + FUS",shortLabel:"SP2+FUS",color:"#fbbf24",dash:[4,4],final:420,shape:"bi1"},{label:"SP2 + AAV",shortLabel:"SP2+AAV",color:"#34d399",dash:[4,4],final:350,shape:"bi2"},{label:"AAV + FUS",shortLabel:"AAV+FUS",color:"#60a5fa",dash:[4,4],final:280,shape:"bi3"},{label:"Tri-Modal (SP2+AAV+FUS)",shortLabel:"Tri-Modal",color:"#38bdf8",dash:[],final:180,shape:"tri",bold:!0}],d=250,c=32,m=20,f=48,h=60,g=(t,e)=>{const i=[];for(let a=0;a<d;a+=1){const n=a/249,s=18*(Math.random()-.5)*(1-.6*n);let r;r="rise"===t?890+(e-890)*Math.pow(n,.55):"mild"===t?890-(890-e)*(1-Math.exp(-3.2*n)):"mild2"===t?890-(890-e)*(1-Math.exp(-3.8*n)):"bi1"===t?890-(890-e)*(1-Math.exp(-4.2*n)):"bi2"===t?890-(890-e)*(1-Math.exp(-4.5*n)):"bi3"===t?890-(890-e)*(1-Math.exp(-5*n)):890-(890-e)*(1-Math.exp(-6*n)),i.push(r+s)}return i},y=t=>{let{location:e}=t;return n.createElement(n.Fragment,null,n.createElement(s.A,{title:"A Novel Tri-Modal Viral–Ultrasound Gene-Delivery Therapy Protocol for Lysosomal Neurodegeneration via Stochastic Model Optimization with Uncertainty Quantification and Generalizability",description:"Computationally optimized tri-modal AAV-T4, SP2, and focused ultrasound gene-delivery protocol for lysosomal neurodegeneration.",pathname:e.pathname}),n.createElement("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),n.createElement("link",{rel:"preconnect",href:"https://fonts.gstatic.com",crossOrigin:""}),n.createElement("link",{href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;600&display=swap",rel:"stylesheet"}))};e.default=()=>{const t=n.useRef(null);return n.useEffect((()=>{if(!t.current)return;const e=t.current.querySelector("#hero-canvas"),n=e?(t=>{const e=t.getContext("2d"),i=o.map((t=>({...t,data:g(t.shape,t.final)}))),n=i.flatMap((t=>t.data)),s=Math.min.apply(Math,(0,a.A)(n))-50,r=Math.max.apply(Math,(0,a.A)(n))+50;let l=null,y=null,p=0,u=0;const x=()=>{const i=window.devicePixelRatio||1,a=t.parentElement.getBoundingClientRect();p=a.width,u=Math.min(360,.42*p),t.width=p*i,t.height=u*i,t.style.width=`${p}px`,t.style.height=`${u}px`,e.setTransform(i,0,0,i,0,0)},b=t=>h+t/249*(p-h-m),v=t=>c+(1-(t-s)/(r-s))*(u-c-f),w=t=>{y||(y=t);const a=p<520,n=(t-y)%5200/5200,s=n<.7?n/.7:1,r=n<.85?1:1-(n-.85)/.15,o=s<1?1-Math.pow(1-s,2.5):1,g=Math.max(2,Math.floor(o*d));e.clearRect(0,0,p,u),e.fillStyle="#0d1117",e.fillRect(0,0,p,u),[200,400,600,800,1e3,1200,1400].forEach((t=>{const i=v(t);i<c||i>u-f||(e.strokeStyle="rgba(255,255,255,0.06)",e.lineWidth=1,e.setLineDash([]),e.beginPath(),e.moveTo(h,i),e.lineTo(p-m,i),e.stroke(),e.fillStyle="rgba(255,255,255,0.28)",e.font="10px Inter, sans-serif",e.textAlign="right",e.fillText(t,h-8,i+4))}));const x=v(500);e.strokeStyle="rgba(251,146,60,0.35)",e.lineWidth=1,e.setLineDash([5,5]),e.beginPath(),e.moveTo(h,x),e.lineTo(p-m,x),e.stroke(),e.setLineDash([]),e.fillStyle="rgba(251,146,60,0.5)",e.font=a?"8px Inter, sans-serif":"9px Inter, sans-serif",e.textAlign="left",e.fillText(a?"G_th = 500":"G_th = 500 nmol/g (microglial activation)",h+6,x-5),e.strokeStyle="rgba(255,255,255,0.2)",e.lineWidth=1.5,e.beginPath(),e.moveTo(h,c),e.lineTo(h,u-f),e.lineTo(p-m,u-f),e.stroke(),[0,90,180,270,365].forEach((t=>{const i=h+t/365*(p-h-m);e.fillStyle="rgba(255,255,255,0.35)",e.font="10px Inter, sans-serif",e.textAlign="center",e.fillText(`Day ${t}`,i,u-f+15)})),e.save(),e.translate(14,u/2),e.rotate(-Math.PI/2),e.fillStyle="rgba(255,255,255,0.35)",e.font="10px Inter, sans-serif",e.textAlign="center",e.fillText("Brain GM2 burden (nmol g⁻¹)",0,0),e.restore(),i.forEach((t=>{if(t.bold)return;const i=t.data.slice(0,g);i.length<2||(e.globalAlpha=.7*r,e.strokeStyle=t.color,e.lineWidth=1.5,e.setLineDash(t.dash),e.lineJoin="round",e.beginPath(),i.forEach(((t,i)=>{0===i?e.moveTo(b(i),v(t)):e.lineTo(b(i),v(t))})),e.stroke(),e.setLineDash([]))}));const A=i.find((t=>t.bold));if(A){const t=A.data.slice(0,g);if(t.length>=2&&(e.globalAlpha=r,e.strokeStyle=A.color,e.lineWidth=3,e.setLineDash([]),e.lineJoin="round",e.shadowColor=A.color,e.shadowBlur=10,e.beginPath(),t.forEach(((t,i)=>{0===i?e.moveTo(b(i),v(t)):e.lineTo(b(i),v(t))})),e.stroke(),e.shadowBlur=0,g>180)){const i=t[t.length-1],a=b(g-1),n=v(i);e.globalAlpha=r*Math.min(1,(g-180)/40),e.fillStyle=A.color,e.font="bold 11px Inter, sans-serif",e.textAlign="left",e.fillText("↓ 75.7%  (180 nmol/g)",a+6,n+4)}}if(e.globalAlpha=1,!a){const t=p-m-190,a=c+6;i.forEach(((i,n)=>{const s=a+16*n;e.strokeStyle=i.color,e.lineWidth=i.bold?2.5:1.5,e.setLineDash(i.dash),e.globalAlpha=i.bold?1:.7,e.beginPath(),e.moveTo(t,s),e.lineTo(t+22,s),e.stroke(),e.setLineDash([]),e.globalAlpha=1,e.fillStyle=i.bold?"#ffffff":"rgba(255,255,255,0.5)",e.font=i.bold?"bold 9.5px Inter, sans-serif":"9px Inter, sans-serif",e.textAlign="left",e.fillText(i.label,t+28,s+3.5)}))}if(g<d){const t=Math.round(g/d*365);e.fillStyle="rgba(255,255,255,0.25)",e.font="9px Inter, sans-serif",e.textAlign="left",e.fillText(`Day ${t} / 365`,h+6,c+14)}l=window.requestAnimationFrame(w)},A=()=>{x(),y=null};return x(),l=window.requestAnimationFrame(w),window.addEventListener("resize",A),()=>{window.removeEventListener("resize",A),l&&window.cancelAnimationFrame(l)}})(e):void 0,s=Array.from(t.current.querySelectorAll(".tab-btn")).map((t=>{const e=()=>{const e=t.closest(".sde-tabs");if(!e)return;e.querySelectorAll(".tab-btn").forEach((t=>t.classList.remove("active"))),e.querySelectorAll(".tab-panel").forEach((t=>t.classList.remove("active"))),t.classList.add("active");const i=e.querySelector(`[data-panel="${t.dataset.tab}"]`);i&&i.classList.add("active")};return t.addEventListener("click",e),[t,e]}));return Promise.all([i.e(611),i.e(529)]).then(i.bind(i,3529)).then((e=>{(e.default||e)(t.current,{delimiters:[{left:"\\[",right:"\\]",display:!0},{left:"\\(",right:"\\)",display:!1}],throwOnError:!1})})),()=>{n&&n(),s.forEach((t=>{let[e,i]=t;return e.removeEventListener("click",i)}))}}),[]),n.createElement("div",{className:"trimod-page",ref:t},n.createElement("nav",{className:"navbar"},n.createElement(r.Link,{className:"nav-brand",to:"/"},n.createElement("svg",{width:"34",height:"34",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg"},n.createElement("circle",{cx:"30",cy:"30",r:"30",fill:"#BF5700"}),n.createElement("text",{x:"50%",y:"55%",dominantBaseline:"middle",textAnchor:"middle",fill:"white",fontSize:"21",fontWeight:"800",fontFamily:"Georgia, serif"},"UT")),n.createElement("div",null,n.createElement("div",{className:"nav-brand-text"},"Oden Institute",n.createElement("span",{className:"nav-brand-sub"},"The University of Texas at Austin")))),n.createElement("ul",{className:"nav-links"},n.createElement("li",null,n.createElement(r.Link,{to:"/"},"Home")),n.createElement("li",null,n.createElement(r.Link,{to:"/projects"},"Projects")),n.createElement("li",null,n.createElement(r.Link,{to:"/people"},"People")),n.createElement("li",null,n.createElement(r.Link,{to:"/publications"},"Publications")),n.createElement("li",null,n.createElement(r.Link,{to:"/news"},"News")),n.createElement("li",null,n.createElement(r.Link,{to:"/software"},"Software")),n.createElement("li",null,n.createElement(r.Link,{to:"/#about"},"About")))),n.createElement("div",{dangerouslySetInnerHTML:{__html:l}}))}},7528:function(t,e,i){var a=i(6540),n=i(4794);e.A=function(t){let{description:e="",lang:i="en",meta:s=[],title:r,pathname:l,image:o}=t;const{site:d}=(0,n.useStaticQuery)("3764592887"),c=d.siteMetadata.title,m=(d.siteMetadata.siteUrl||"").replace(/\/+$/,""),f=e||d.siteMetadata.description,h=r&&r!==c?`${r} | ${c}`:c,g=l&&m?`${m}${l}`:void 0,y=m?`${m}${o||"/og-image.jpg"}`:void 0;return a.createElement(a.Fragment,null,a.createElement("html",{lang:i}),a.createElement("title",null,h),a.createElement("meta",{name:"description",content:f}),g&&a.createElement("link",{rel:"canonical",href:g}),a.createElement("meta",{property:"og:site_name",content:c}),a.createElement("meta",{property:"og:title",content:h}),a.createElement("meta",{property:"og:description",content:f}),a.createElement("meta",{property:"og:type",content:"website"}),g&&a.createElement("meta",{property:"og:url",content:g}),y&&a.createElement("meta",{property:"og:image",content:y}),a.createElement("meta",{name:"twitter:card",content:y?"summary_large_image":"summary"}),a.createElement("meta",{name:"twitter:title",content:h}),a.createElement("meta",{name:"twitter:description",content:f}),y&&a.createElement("meta",{name:"twitter:image",content:y}),s.map((t=>{let{name:e,content:i,property:n}=t;return n?a.createElement("meta",{key:n,property:n,content:i}):a.createElement("meta",{key:e,name:e,content:i})})))}}}]);
//# sourceMappingURL=component---src-pages-projects-tri-modal-gene-therapy-js-9551c52e4db4edca1807.js.map